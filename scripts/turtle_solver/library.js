...
canv.addEventListener('click', function (e) {  // use event argument
    copyTextToClipboard((canvasX - 1500 / 2) + "," + (-canvasY + 1500 / 2));
...
canv.addEventListener("mousemove", function (event) {
    ...
    canvasX = coords.x;
    canvasY = coords.y;
    co.innerHTML = "X:" + (canvasX - 1500 / 2) + " Y:" + (-canvasY + 1500 / 2);
...
function draw() {
    ...
    turtleContext.drawImage(imageCanvas, 0, 0, 1500, 1500, 0, 0, 1500, 1500);
}
